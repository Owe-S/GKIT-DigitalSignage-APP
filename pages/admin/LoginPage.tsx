...
import { mockLogin, loginWithGoogle } from '../../services/api';
...
export const LoginPage: React.FC = () => {
  ...
  const handleLogin = async (e: React.FormEvent) => {
    ...
    setLoading(true);
    try {
      // Dette er fortsatt mock/enkel email login inntil vi aktiverer Firebase Email auth
    ...
    <div className="min-h-screen w-full bg-slate-900 flex items-center justify-center p-4">
      <div className="max-w-md w-full bg-slate-800/50 backdrop-blur-lg rounded-2xl border border-slate-700 p-8 shadow-2xl">
        ...
        <div className="flex flex-col items-center mb-8">
          ...
          <h1 className="text-2xl font-bold text-white">LoftLogic Admin</h1>
